                    ...
                    <div className='footer-wrapper'>
                        ...
                        <div className='footer-info-section'>
                            <ul className='footer-info-ul'>
                                <li>
                                    <a href="/about" data-uuid="7k1NZYpe6blkKmI7qo2UCv" data-testid="ui-nav-link" className='footer-info-link'>
                                ...
                                <li>
                                    <a href="/platforms" data-uuid="2ZWkwhk6wBiZzCA3bXUH4H" data-testid="ui-nav-link" className='footer-info-link'>
                                ...
                                <li>
                                    <a href="/contact" data-uuid="7ptPwcapCPwGgn3DOehuCa" data-testid="ui-nav-link" className='footer-info-link'>
